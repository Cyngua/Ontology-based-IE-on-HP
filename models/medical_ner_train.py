...
tokenizer = AutoTokenizer.from_pretrained("blaze999/Medical-NER") # TODO: add tokenizer
MAX_LEN = 128
...
# Step IV: Load Model
model = AutoModelForTokenClassification.from_pretrained("blaze999/Medical-NER") # TODO: load model
model.to(device)
